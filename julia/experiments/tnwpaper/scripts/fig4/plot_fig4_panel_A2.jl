...
function main(args)
    ...
    phi = 0.5
    Devals = [0.1, 1.0, 10.0, 30.0, 100.0]
    drag_model = "c2d2"
    NK = 3000
    hK = 0.05
    ...
    reltext!(ax, 0.03, 0.93, "A (ii)"; sty=sty, color=:black, fs_scale=1.35)
    reltext!(ax, 0.08, 0.40, L"\phi = 0.5"; sty=sty)
    ...
    save_panel(fig, figdir, "fig4_panel_A2")
end
